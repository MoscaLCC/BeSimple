...
namespace BragaInstall
{
    public class OrdemServico
    {
        ...
        public OrdemServico(String nome, int id, Boolean estado, String Modelo, String Marca, String Morada, float Vmedio, float Vcompra, float Vportes, float Vvenda, float Vvendido, float Vlucro, float VCT, float Vcorreios, float Vsaco, String data)
        {
            this.nome = nome;
            this.id = id;
            this.estado = estado;
